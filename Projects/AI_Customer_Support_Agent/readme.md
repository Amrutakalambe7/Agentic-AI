...
🛠️ Tools: SmolAgent (CodeAgent), LangChain, Hugging Face
📡 Integration: Twilio API (for WhatsApp/SMS), Zendesk API

🤖 Real-World Application:
⚡️ Detects negative sentiments and prioritizes critical customer issues.
⚡️ Improves customer satisfaction by ensuring human intervention when needed.
